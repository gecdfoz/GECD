...
Links complementares sobre GIT
...
- [Git for Humans](https://speakerdeck.com/alicebartlett/git-for-humans?slide=95) by [Alice Bartlett](https://twitter.com/alicebartlett)
...
- [Introdução Git](https://www.youtube.com/embed/videoseries?list=PLevVxVF0KI-DZM6IyBXop7FV6nJeC90hd&hl=en_US)
- [Curso GIT e GITHUB - Como instalar e configurar o GIT no windows](https://www.youtube.com/watch?v=SOxafinthys&feature=youtu.be)
- [Tutorial instalação Python 3.7.1 e VS Code no Windows 10](https://www.youtube.com/watch?v=xGkQveGpieI&feature=youtu.be)
